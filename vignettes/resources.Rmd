...
`r Biocpkg("iSEEindex")` requires each URI to contain a scheme [Wikipedia][scheme-wikipedia] component, which is used to identify the type of resource and invoke the associated method for accessing it.
